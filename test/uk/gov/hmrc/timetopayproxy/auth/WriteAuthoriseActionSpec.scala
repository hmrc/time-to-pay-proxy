...
class WriteAuthoriseActionSpec extends AnyFreeSpec with MockFactory with DefaultAwaitTimeout {
  ...
  class Setup {
    val authAction = new WriteAuthoriseAction(mockAuthConnector, cc, featureSwitch)
