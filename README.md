...
# How to import time-to-pay-proxy Bruno collection
Click [here](timeToPayProxyBrunoCollectionAndGlobal/README.md) to follow the guide to import the Bruno collection
