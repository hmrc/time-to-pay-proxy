...
sealed abstract class ChargeAmendment(override val entryName: String) extends EnumEntry

object ChargeAmendment extends Enum[ChargeAmendment] with PlayJsonEnum[ChargeAmendment] {
